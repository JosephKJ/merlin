...
class Net(nn.Module):
    def __init__(self,
        ...
        self.opt = optim.SGD(self.parameters(), 0.05)

        self.n_memories = 100
        self.n_sampled_memories = 300
        ...
        self.slack = 0
        self.normalize = False
        self.change_th = 0.0  # gradient direction change threshold to re-select constraints
        ...
        self.subselect = 0  # if 1, first select from recent memory and then add to samples memories
